...
#define CONFIGURE_ARGS " '--prefix=/usr/local/pgsql' '--with-llvm' 'CFLAGS=-DPG_NO_DEBUG' 'PKG_CONFIG_PATH=/mingw64/lib/pkgconfig:/mingw64/share/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 14.2 on x86_64-w64-mingw32, compiled by gcc.exe (Rev10, Built by MSYS2 project) 11.2.0, 64-bit"
